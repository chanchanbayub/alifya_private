                    ...
                    <div class="card recent-sales overflow-auto">
                        ...
                        <div class="filter">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                ...
                                <li><a type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"><i class="bi bi-plus"></i> Tambah Layanan</a></li>
                            </ul>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($layanan as $layanan) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-outline-warning" id="edit" data-bs-toggle="modal" data-bs-target="#editModal" data-id="<?= $layanan->id ?>" type="button">
                                                    <i class="bi bi-pencil-square"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-danger" id="delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="<?= $layanan->id ?>" type="button">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="add_form">
                    ...
                    <div class="mb-3">
                        <label for="nama_layanan" class="col-form-label">Layanan AHL :</label>
                        <input type="text" name="nama_layanan" id="nama_layanan" class="form-control" placeholder="Private / AHL">
            ...
            <div class="modal-body">
                <form id="edit_form" autocomplete="off">
                    ...
                    <div class="mb-3">
                        ...
                        <label for="nama_layanan_edit" class="col-form-label">Layanan AHL:</label>
                        <input type="text" name="nama_layanan" id="nama_layanan_edit" class="form-control">
                ...
                success: function(response) {
                    ...
                    if (response.error) {
                        ...
                        if (response.error.nama_layanan) {
                            ...
                            $(".error-layanan").html(response.error.nama_layanan);
                        } else {
            ...
            success: function(response) {
                ...
                if (response.error) {
                    ...
                    if (response.error.nama_layanan) {
                        ...
                        $(".error-layanan-edit").html(response.error.nama_layanan);
                    } else {
