                    ...
                    <div class="card recent-sales overflow-auto">
                        ...
                        <div class="filter">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                ...
                                <li><a type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"><i class="bi bi-plus"></i> Tambah Tingkat Pendidikan</a></li>
                            </ul>
                        </div>

                        <div class="card-body">
                            <h5 class="card-title">Tingkat Pendidikan <span>| Table </span></h5>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($pendidikan as $pendidikan) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-outline-warning" id="edit" data-bs-toggle="modal" data-bs-target="#editModal" data-id="<?= $pendidikan->id ?>" type="button">
                                                    <i class="bi bi-pencil-square"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-danger" id="delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="<?= $pendidikan->id ?>" type="button">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Tingkat Pendidikan</h1>
            ...
            <div class="modal-body">
                <form id="add_form">
                    <?= csrf_field(); ?>
                    <div class="mb-3">
                        <label for="pendidikan" class="col-form-label">Tingkatan Pendidikan :</label>
                        <input type="text" class="form-control" id="pendidikan" name="pendidikan" placeholder="sd">
...
<div class="modal fade" id="editModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"> Form <small>Edit Tingkat Pendidikan</small> </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="edit_form" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <label for="pendidikan_edit" class="col-form-label">Tingkat Pendidikan :</label>
...
<div class="modal fade" id="deleteModal" tabindex="0">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Form <small> Hapus Tingkat Pendidikan </small></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="delete_form">
...
<script>
                ...
                success: function(response) {
                    ...
                    if (response.error) {
                        if (response.error.pendidikan) {
                            ...
                            $(".error-status").html(response.error.pendidikan);
                        } else {
    ...
    $(document).on('click', "#edit", function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#pendidikan_edit").val(response.pendidikan);
    ...
    $("#edit_form").submit(function(e) {
        e.preventDefault();
        let id = $('#id_edit').val();
        let pendidikan = $('#pendidikan_edit').val();

        $.ajax({
            url: '/admin/pendidikan/update',
            method: 'post',
            dataType: 'JSON',
            data: {
                id: id,
            ...
            success: function(response) {
                ...
                if (response.error) {
                    if (response.error.pendidikan) {
                        $("#pendidikan_edit").addClass('is-invalid');
                        $(".error-status-edit").html(response.error.pendidikan);
                    } else {
                        $("#pendidikan_edit").removeClass('is-invalid');
