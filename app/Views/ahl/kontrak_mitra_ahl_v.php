            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            <h5 class="card-title">Cek Kontrak Mitra AHL</h5>
...
<script>
    $(document).ready(function(e) {
        ...
        $("#add_form").submit(function(e) {
            ...
            $.ajax({
                url: '/admin/kontrak_mitra_ahl/insert',
                method: 'post',
                dataType: 'JSON',
                data: {
    ...
    $(document).on('click', "#edit", function(e) {
        ...
        $.ajax({
            url: '/admin/kontrak_mitra_ahl/edit',
            method: 'get',
            dataType: 'JSON',
            data: {
                id: id,
            ...
            success: function(response) {
                ...
                response.mitra_pengajar.forEach(function(e) {
                    mitra_pengajar_data
                        += `<option value="${e.mitra_id}"> ${e.nama_lengkap} </option>`
                });
    ...
    $("#edit_form").submit(function(e) {
        ...
        $.ajax({
            url: '/admin/kontrak_mitra_ahl/update',
            method: 'post',
            dataType: 'JSON',
            data: {
                id: id,
    ...
    $("#delete_form").submit(function(e) {
        ...
        $.ajax({
            url: '/admin/kontrak_mitra_ahl/delete',
            method: 'post',
            dataType: 'JSON',
            data: {
                id: id,
    ...
    $(document).ready(function(e) {
        $("#cek_kontrak_mitra").submit(function(e) {
            ...
            let bulan = $("#bulan").val();
            $.ajax({
                url: '/admin/kontrak_mitra_ahl/kontrak_perbulan',
                data: {
                    bulan: bulan
                },
                dataType: 'json',
