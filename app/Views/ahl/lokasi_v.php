                    ...
                    <div class="card recent-sales overflow-auto">
                        ...
                        <div class="filter">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                ...
                                <li><a type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"><i class="bi bi-plus"></i> Tambah Lokasi Presensi</a></li>
                            </ul>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($lokasi as $lokasi) : ?>
                                        <tr>
                                            ...
                                            <td><?= $lokasi->lokasi ?></td>
                                            <td>
                                                <button class="btn btn-sm btn-outline-warning" id="edit" data-bs-toggle="modal" data-bs-target="#editModal" data-id="<?= $lokasi->id ?>" type="button">
                                                    <i class="bi bi-pencil-square"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-danger" id="delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="<?= $lokasi->id ?>" type="button">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="add_form">
                    ...
                    <div class="mb-3">
                        <label for="lokasi" class="col-form-label">Lokasi Presensi :</label>
                        <input type="text" name="lokasi" id="lokasi" class="form-control" placeholder="Perum Casablanca">
            ...
            <div class="modal-body">
                <form id="edit_form" autocomplete="off">
                    ...
                    <div class="mb-3">
                        ...
                        <label for="lokasi_edit" class="col-form-label">Lokasi Presensi:</label>
                ...
                success: function(response) {
                    ...
                    if (response.error) {
                        ...
                        if (response.error.lokasi) {
                            ...
                            $(".error-lokasi").html(response.error.lokasi);
                        } else {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.error) {
                    ...
                    if (response.error.lokasi) {
                        $("#lokasi_edit").addClass('is-invalid');
                        $(".error-lokasi-edit").html(response.error.lokasi);
                    } else {
                        $("#lokasi_edit").removeClass('is-invalid');
