                ...
                <div class="col-md-6">
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            ...
                            <form class="row g-3 text-capitalize" id="export_excel" action="/export_invoice_mitra_ahl">
                                <?= csrf_field(); ?>
                                <div class="col-md-12">
                                    <label for="bulan" class="form-label">Pilih Bulan :</label>
