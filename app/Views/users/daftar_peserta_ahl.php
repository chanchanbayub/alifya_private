            ...
            <div class="col-lg-12 mb-5">
                ...
                <div class="contact-form">
                    ...
                    <form name="sentMessage" id="sendLamaran" novalidate="novalidate">
                        ...
                        <div class="control-group">
                            <label for="program_belajar_id">Brosur Alifya Home Learning (<a href="/assets/img/price_list_baru_ahl.png" target="_blank">Lihat Brosur</a>) :</label>
                            <br>
                            <img src="/assets/img/price_list_baru_ahl.png" alt="brosur" width="350">
                        </div>
                        <br>
