                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($kelompok as $kelompok) : ?>
                                        <tr>
                                            ...
                                            <td><a href="/admin/kelompok/view/<?= $kelompok->id ?>" class="btn btn-outline-info btn-sm"><?= $kelompok->kelompok ?></a></td>
                                            <td><?= $kelompok->nama_lengkap ?></td>
                                            <td>
                                                <button class="btn btn-sm btn-outline-warning" id="edit" data-bs-toggle="modal" data-bs-target="#editModal" data-id="<?= $kelompok->id ?>" type="button">
                                                    <i class="bi bi-pencil-square"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-danger" id="delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="<?= $kelompok->id ?>" type="button">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="add_form">
                    <?= csrf_field(); ?>
                    <div class="mb-3">
                        <label for="kelompok" class="col-form-label">Kelompok Pengajar :</label>
                        <input type="text" class="form-control" id="kelompok" name="kelompok" placeholder="Kelompok 1">
                        <div class="invalid-feedback error-kelompok">
                        </div>
                    </div>

                    <div class="mb-3">
                        <label for="mitra_pengajar_id" class="col-form-label">Pilih Pengajar :</label>
            ...
            <div class="modal-body">
                <form id="edit_form" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <label for="kelompok_edit" class="col-form-label"><?= $title ?> :</label>
                        <input type="text" class="form-control" id="kelompok_edit" name="kelompok">
...
<script>
    ...
    $(document).on('click', "#edit", function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#id_edit").val(response.kelompok.id);
                $("#kelompok_edit").val(response.kelompok.kelompok);
                ...
                $("#mitra_pengajar_id_edit").val(response.kelompok.mitra_pengajar_id).trigger('change');
    ...
    $("#edit_form").submit(function(e) {
        e.preventDefault();
        let id = $('#id_edit').val();
        let kelompok = $("#kelompok_edit").val();
        let mitra_pengajar_id = $('#mitra_pengajar_id_edit').val();

        $.ajax({
            url: '/admin/kelompok/update',
            method: 'post',
            dataType: 'JSON',
            data: {
                id: id,
            ...
            success: function(response) {
                ...
                if (response.error) {
                    if (response.error.kelompok) {
                        $("#kelompok_edit").addClass('is-invalid');
                        $(".error-kelompok-edit").html(response.error.kelompok);
                    } else {
                        $("#kelompok_edit").removeClass('is-invalid');
    ...
    $(document).on('click', "#delete", function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                $("#id_delete").val(response.kelompok.id);
            }
        });
    });
