        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="add_form">
                    ...
                    <div class="mb-3">
                        <label for="usia_anak" class="col-form-label">Jumlah Pertemuan :</label>
                        <input class="form-control" id="usia_anak" name="usia_anak" placeholder="2 - 3 Tahun"></input>
            ...
            <div class="modal-body">
                <form id="edit_form" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" id="banner_lama" name="banner_lama">
                    ...
                    <div class="form-group">
                        ...
                        <input name="usia_anak" id="usia_anak_edit" class="form-control" placeholder="2 - 3 Tahun">
