        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="add_form">
                    <?= csrf_field(); ?>
                    <div class="mb-3">
                        <label for="materi_belajar" class="col-form-label">Materi Belajar :</label>
                        <textarea name="materi_belajar" id="materi_belajar" class="form-control"></textarea>
            ...
            <div class="modal-body">
                <form id="edit_form" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <label for="materi_belajar_edit" class="col-form-label">Materi Belajar:</label>
                        <textarea name="materi_belajar" id="materi_belajar_edit" class="form-control"></textarea>
...
<script>
    $(document).ready(function(e) {
        ...
        $("#add_form").submit(function(e) {
            ...
            let materi_belajar = $("#materi_belajar").val();
            let link = $("#link").val();
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.error) {
                        if (response.error.materi_belajar) {
                            $("#materi_belajar").addClass('is-invalid');
                            $(".error-materi-belajar").html(response.error.materi_belajar);
                        } else {
                            $("#materi_belajar").removeClass('is-invalid');
    ...
    $(document).on('click', "#edit", function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#materi_belajar_edit").val(response.alat_pengajaran.materi_belajar);
    ...
    $("#edit_form").submit(function(e) {
        e.preventDefault();
        let id = $('#id_edit').val();
        let materi_belajar = $('#materi_belajar_edit').val();
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.error) {
                    if (response.error.materi_belajar) {
                        $("#materi_belajar_edit").addClass('is-invalid');
                        $(".error-materi_belajar-edit").html(response.error.materi_belajar);
                    } else {
                        $("#materi_belajar_edit").removeClass('is-invalid');
                        $(".error-materi_belajar-edit").html('');
                    }
                    if (response.error.link) {
