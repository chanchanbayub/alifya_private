...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Alat Tim</li>
        </ol>
    </nav>
</div><!-- End Page Title -->
                    ...
                    <div class="card recent-sales overflow-auto">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered datatable">
                                ...
                                <tbody>
                                    <?php $no = 1; ?>
                                    <?php foreach ($alat_tim as $alat_tim) : ?>
                                        <tr>
                                            <th scope="row"><a href="#"><?= $no++ ?></a></th>
                                            <td><?= $alat_tim->keterangan ?> </td>
                                            <td><a href="<?= $alat_tim->links ?>" target="_blank" class="btn btn-sm btn-primary">Kunjungi Links</a></td>
                                            <td>
                                                <button class="btn btn-sm btn-outline-warning" id="edit" data-bs-toggle="modal" data-bs-target="#editModal" data-id="<?= $alat_tim->id ?>" type="button">
                                                    <i class="bi bi-pencil-square"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-danger" id="delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="<?= $alat_tim->id ?>" type="button">
            ...
            <div class="modal-body">
                <form id="add_form">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="invalid-feedback error-links">
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <form id="edit_form" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="links" id="link_edit" class="form-control"></textarea>
                        <div class="invalid-feedback error-links-edit">
...
<script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.error) {
                        ...
                        if (response.error.links) {
                            $("#links").addClass('is-invalid');
                            $(".error-links").html(response.error.links);
                        } else {
    ...
    $(document).on('click', "#edit", function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#id_edit").val(response.alat_tim.id);

                $("#keterangan_edit").val(response.alat_tim.keterangan);

                $("#link_edit").val(response.alat_tim.links);
            }
        });
    });
    ...
    $("#edit_form").submit(function(e) {
        ...
        let links = $('#link_edit').val();
        $.ajax({
            url: '/admin/alat_tim/update',
            method: 'post',
            dataType: 'JSON',
            data: {
                id: id,
            ...
            success: function(response) {
                ...
                if (response.error) {
                    ...
                    if (response.error.links) {
                        ...
                        $(".error-links-edit").html(response.error.links);
                    } else {
                        $("#link_edit").removeClass('is-invalid');
                        $(".error-links-edit").html('');
                    }
    ...
    $(document).on('click', "#delete", function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                $("#id_delete").val(response.alat_tim.id);
            }
        });
    });
