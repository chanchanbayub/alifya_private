                    ...
                    <div class="card recent-sales overflow-auto">
                        ...
                        <div class="filter">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                ...
                                <li><a type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"><i class="bi bi-plus"></i> Tambah paket Belajar</a></li>
                            </ul>
                        </div>

                        <div class="card-body">
                            <h5 class="card-title">Paket Belajar <span>| Table </span></h5>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($paket_belajar as $paket) : ?>
                                        <tr>
                                            ...
                                            <td><?= $paket->jumlah_pertemuan ?> x dalam sebulan</td>
                                            <td>Rp. <?= number_format($paket->harga) ?> </td>
                                            <td>
                                                <button class="btn btn-sm btn-outline-warning" id="edit" data-bs-toggle="modal" data-bs-target="#editModal" data-id="<?= $paket->id ?>" type="button">
                                                    <i class="bi bi-pencil-square"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-danger" id="delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="<?= $paket->id ?>" type="button">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Paket Belajar</h1>
            ...
            <div class="modal-body">
                <form id="add_form">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_paket" name="nama_paket" placeholder="cth: smart">
...
<div class="modal fade" id="editModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"> Form <small>Edit paket Belajar</small> </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="edit_form" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama_paket_edit" name="nama_paket">
...
<div class="modal fade" id="deleteModal" tabindex="0">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Form <small> Hapus paket Belajar </small></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="delete_form">
...
<script>
    $(document).ready(function(e) {
        $("#add_form").submit(function(e) {
            ...
            $.ajax({
                url: '/admin/paket_belajar/insert',
                data: formData,
                dataType: 'json',
                type: 'POST',
                contentType: false,
    ...
    $("#edit_form").submit(function(e) {
        ...
        $.ajax({
            url: '/admin/paket_belajar/update',
            data: formData,
            dataType: 'json',
            type: 'POST',
            contentType: false,
    ...
    $("#delete_form").submit(function(e) {
        ...
        $.ajax({
            url: '/admin/paket_belajar/delete',
            method: 'post',
            dataType: 'JSON',
            data: {
                id: id,
