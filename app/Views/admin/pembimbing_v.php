                    ...
                    <div class="card recent-sales overflow-auto">
                        ...
                        <div class="filter">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                ...
                                <li><a type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"><i class="bi bi-plus"></i> Tambah Pembimbing</a></li>
                            </ul>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($pembimbing as $pembimbing) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-outline-warning" id="edit" data-bs-toggle="modal" data-bs-target="#editModal" data-id="<?= $pembimbing->id ?>" type="button">
                                                    <i class="bi bi-pencil-square"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-danger" id="delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="<?= $pembimbing->id ?>" type="button">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Tunjuk Pembimbing</h1>
            ...
            <div class="modal-body">
                <form id="edit_form" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <label for="mitra_pengajar_id_edit" class="col-form-label"><?= $title ?> :</label>
...
<script>
    ...
    $(document).on('click', "#edit", function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#id_edit").val(response.pembimbing.id);


                let mitra = `<option value="">--Silahkan Pilih--</option>`;

                response.pengajar.forEach(function(e) {
                    mitra += `<option value="${e.id}"> ${e.nama_lengkap} </option>`
                });

                $("#mitra_pengajar_id_edit").html(mitra);

                $("#mitra_pengajar_id_edit").val(response.pembimbing.mitra_pengajar_id).trigger('change');
    ...
    $(document).on('click', "#delete", function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                $("#id_delete").val(response.pembimbing.id);
            }
        });
    });
