                ...
                <form id="add_form">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="mitra_id" id="mitra_id" class="form-control">
                            <option value="<?= $mitra_pengajar_ahl->mitra_id ?>" selected><?= $mitra_pengajar_ahl->nama_lengkap ?></option>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tanggal" id="tanggal" class="form-control" value="<?= date('Y-m-d') ?>" disabled>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" name="jam" id="jam" class="form-control" value="<?= date('H:i') ?>" disabled>
...
<script>
    $(document).ready(function(e) {
        ...
        $("#add_form").submit(function(e) {
            ...
            $.ajax({
                url: '/mitra_pengajar/presensi_ahl_mitra/insert',
                data: formData,
                dataType: 'json',
