...
<script>
    $(document).ready(function(e) {
        ...
        $('#mitra_pengajar_id').change(function(e) {
            ...
            $.ajax({
                url: '/mitra_pengajar/jadwal_tetap/getPesertaDidik',
                method: 'get',
                dataType: 'JSON',
                data: {
        ...
        $("#add_form").submit(function(e) {
            ...
            $.ajax({
                url: '/mitra_pengajar/jadwal_tetap/insert',
                method: 'post',
                dataType: 'JSON',
                data: {
                    hari_id: hari_id,
    ...
    $(document).on('click', "#edit", function(e) {
        ...
        $.ajax({
            url: '/mitra_pengajar/jadwal_tetap/edit',
            method: 'get',
            dataType: 'JSON',
            data: {
                id: id,
    ...
    //     $.ajax({
    //         url: '/mitra/jadwal_tetap/getPesertaDidik',
    //         method: 'get',
    //         dataType: 'JSON',
    //         data: {
    //             mitra_pengajar_id: mitra_pengajar_id,
    ...
    $("#edit_form").submit(function(e) {
        ...
        $.ajax({
            url: '/mitra_pengajar/jadwal_tetap/update',
            method: 'post',
            dataType: 'JSON',
            data: {
                id: id,
    ...
    $("#delete_form").submit(function(e) {
        ...
        $.ajax({
            url: '/mitra_pengajar/jadwal_tetap/delete',
            method: 'post',
            dataType: 'JSON',
            data: {
                id: id,
