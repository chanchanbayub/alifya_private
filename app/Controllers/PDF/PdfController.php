...
class PdfController extends BaseController
{
    ...
    public function download_invoice_peserta($mitra_pengajar_id, $peserta_didik_id, $bulan, $tahun)
    {
        $this->mpdf->showImageErrors = true;
    ...
    public function download_slip_gaji_ap($mitra_pengajar_id, $bulan, $tahun)
    {
