...
class KuisionerProgresAnakController extends BaseController
{
    ...
    public function index()
    {
        ...
        foreach ($kuisioner_progres as $kuisioner) {
            ...
            $data_kuisioner[] = [
                'id' => $kuisioner->id,
                'pembimbing' => $pembimbing_data->nama_lengkap,
        ...
        if ($pembimbing != null) {
            ...
            return view('admin/kuisioner_progres_anak_v', $data);
        } else {
    ...
    public function edit()
    {
        if ($this->request->isAJAX()) {
            ...
            $kuisioner_progres = $this->kuisionerProgresAnakModel->where(["id" => $id])->first();

            $data = [
                'kuisioner_progress' => $kuisioner_progres,
            ];
    ...
    public function delete()
    {
        if ($this->request->isAJAX()) {
            ...
            $this->kuisionerProgresAnakModel->delete($kuisioner_progres["id"]);

            $alert = [
                'success' => 'Kuisioner Progress Anak Berhasil di Hapus !'
            ];
