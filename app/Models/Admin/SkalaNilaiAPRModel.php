...
class SkalaNilaiAPRModel extends Model
{
    ...
    protected $allowedFields    = ['kategori_apr_id', 'nilai', 'bobot', 'nilai_awal', 'nilai_akhir', 'keterangan'];
    ...
    public function getSkalaNilai()
    {
        return $this->table($this->table)
            ->select('skala_nilai_table.id, skala_nilai_table.kategori_apr_id, skala_nilai_table.nilai, skala_nilai_table.bobot, skala_nilai_table.nilai_awal,skala_nilai_table.nilai_akhir, skala_nilai_table.keterangan, kategori_apr_table.nama_kategori_apr')
