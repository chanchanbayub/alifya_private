...
class PesertaDidikAhlModel extends Model
{
    ...
    protected $allowedFields    = ['id', 'ketersediaan', 'nama_ayah', 'pekerjaan_ayah', 'nama_ibu', 'pekerjaan_ibu', 'agama', 'usersname_instagram', 'nomor_whatsapp_orang_tua', 'alamat_domisili_anak', 'nama_lengkap_anak', 'nama_panggilan_anak', 'tanggal_lahir_anak', 'jenis_kelamin', 'pendidikan_id', 'sekolah_anak', 'riwayat_penyakit', 'ukuran_baju', 'program_belajar_ahl_id', 'jumlah_pertemuan_id', 'foto_anak', 'bukti_tf', 'izin_dokumentasi', 'info_alifya', 'data_1', 'data_2', 'status_peserta_id', 'tanggal_bergabung'];
    ...
    public function getProfil($id)
    {
        return $this->table($this->table)
            ->select("peserta_didik_ahl_table.id, peserta_didik_ahl_table.ketersediaan, peserta_didik_ahl_table.nama_ayah, peserta_didik_ahl_table.pekerjaan_ayah, peserta_didik_ahl_table.pekerjaan_ibu, peserta_didik_ahl_table.nama_ibu, riwayat_penyakit, peserta_didik_ahl_table.usersname_instagram, peserta_didik_ahl_table.nomor_whatsapp_orang_tua, peserta_didik_ahl_table.alamat_domisili_anak, peserta_didik_ahl_table.nama_lengkap_anak, peserta_didik_ahl_table.nama_lengkap_anak, peserta_didik_ahl_table.nama_panggilan_anak, peserta_didik_ahl_table.tanggal_lahir_anak, peserta_didik_ahl_table.jenis_kelamin, peserta_didik_ahl_table.pendidikan_id, peserta_didik_ahl_table.sekolah_anak, peserta_didik_ahl_table.ukuran_baju, peserta_didik_ahl_table.agama, peserta_didik_ahl_table.program_belajar_ahl_id,peserta_didik_ahl_table.jumlah_pertemuan_id ,peserta_didik_ahl_table.foto_anak, peserta_didik_ahl_table.bukti_tf, peserta_didik_ahl_table.izin_dokumentasi, peserta_didik_ahl_table.info_alifya, peserta_didik_ahl_table.data_2, peserta_didik_ahl_table.data_1, peserta_didik_ahl_table.status_peserta_id, program_ahl_table.nama_program, status_murid_table.status_murid, tingkat_pendidikan_table.pendidikan, peserta_didik_ahl_table.tanggal_bergabung, price_list_table.jumlah_pertemuan, price_list_table.harga_paket")
            ->join('program_ahl_table', 'program_ahl_table.id = peserta_didik_ahl_table.program_belajar_ahl_id')
            ->join('tingkat_pendidikan_table', 'tingkat_pendidikan_table.id = peserta_didik_ahl_table.pendidikan_id')
    ...
    public function getPesertaDidikAhl()
    {
        return $this->table($this->table)
    ...
    {
        return $this->table($this->table)
            ->select("sum(price_list_table.harga_paket) as total_harga_paket")
            ->join('program_ahl_table', 'program_ahl_table.id = peserta_didik_ahl_table.program_belajar_ahl_id')
            ->join('price_list_table', 'price_list_table.id = peserta_didik_ahl_table.jumlah_pertemuan_id')
            ->join('status_murid_table', 'status_murid_table.id = peserta_didik_ahl_table.status_peserta_id')
            ->where(["peserta_didik_ahl_table.status_peserta_id" => 1])
